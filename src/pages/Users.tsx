...
const Users = () => {
  const [users, setUsers] = useState<User[]>([
    ...
    { id: '3', name: 'Mike Employee', email: 'mike@company.com', role: 'employee', managerId: '2', status: 'active' },
    { id: '4', name: 'Lisa Employee', email: 'lisa@company.com', role: 'employee', managerId: '2', status: 'active' },
  ]);
  ...
  const handleSaveUser = () => {
    ...
    if (editingUser) {
      setUsers(users.map(u => 
        u.id === editingUser.id 
          ? { ...u, ...formData, id: u.id, status: u.status }
          : u
      ));
